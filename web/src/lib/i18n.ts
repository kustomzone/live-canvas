...
export const messages: Catalogue = {
  ...
  'topbar.theme': { zh: '主题', en: 'Theme' },
  'topbar.theme.system': { zh: '跟随系统', en: 'System' },
  ...
  'preview.generating': { zh: '生成中', en: 'Generating' },
  'preview.back': { zh: '返回', en: 'Back' },
  'preview.retry': { zh: '重试', en: 'Retry' },
